...
if USE_REDIS:
    ...
    # Désactiver Celery si Redis n'est pas disponible
...
if USE_REDIS:
    ...
    # Configuration cache en mémoire (fallback)
    CACHES = {
        'default': {
...
CORS_ALLOWED_ORIGINS = [
    "https://silence-dor.onrender.com",
    "https://www.silence-dor.com",
]
