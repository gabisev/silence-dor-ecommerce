    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(default='fr', max_length=5, verbose_name='language')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('billing', 'Billing Address'), ('shipping', 'Shipping Address'), ('both', 'Both')], max_length=10, verbose_name='address type')),
